...
class GraphPanel(
    ...
    private fun positionSubNodes() {
        ...
        for ((parentId, subNodeIds) in parentToSubNodesMap) {
            ...
            // 1. Chia thành 2 nhóm: sub-node 2 chiều và sub-node bình thường
            ...
            // 2. Đặt sub-node 2 chiều xuống dưới
            ...
            // 3. Đặt các sub-node bình thường: node đầu tiên luôn lên trên
            for ((index, subNodeId) in normalSubNodes.withIndex()) {
                ...
                if (subGeo != null) {
                    ...
                    // Nếu chỉ có 1 sub-node bình thường, luôn đặt lên trên
